...
namespace MusicStore.EntityContext
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MusicStoreEntities>
    {
        protected override void Seed(MusicStoreEntities context)
        {
            new List<Termekek>
            {
                new Termekek { Id = 1, nev = "Activity",  ar = 5590,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Activity.png" },
                 new Termekek { Id = 2, nev = "Bang!",  ar = 3990,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Bang.png" },
                 new Termekek { Id = 3, nev = "Bejeweled",  ar = 7990,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Bejeweled.png" },
                 new Termekek { Id = 4, nev = "Dobókocka szett",  ar = 1290,   tipus = "Kiegészítő", kep = "/Content/Images/kiegek/dobokocka.png" },
                 new Termekek { Id = 5, nev = "DOS",  ar = 1190,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Dos.png" },
                 new Termekek { Id = 6, nev = "Limitált figurák",  ar = 1190,   tipus = "Kiegészítő", kep = "/Content/Images/kiegek/figurak.png" },
                 new Termekek { Id = 7, nev = "Figuraszett",  ar = 450,   tipus = "Kiegészítő", kep = "/Content/Images/kiegek/figuraszett.png" },
                 new Termekek { Id = 8, nev = "Honfoglaló",  ar = 7290,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Honfoglalo.png" },
                 new Termekek { Id = 9, nev = "Kérdezz! Felelek",  ar = 990,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Kerdezz_Felelek.png" },
                 new Termekek { Id = 10, nev = "Ki nevet a végén?",  ar = 2290,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Ki_nevet_a_vegen.png" },
                 new Termekek { Id = 11, nev = "Kockamanók",  ar = 890,   tipus = "Kiegészítő", kep = "//Content/Images/kiegek/kockamano.png" },
                 new Termekek { Id = 12, nev = "Korongok",  ar = 450,   tipus = "Kiegészítő", kep = "/Content/Images/kiegek/korongok.png" },
                 new Termekek { Id = 13, nev = "KRESZ TESZT",  ar = 1690,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Kresz_Teszt.png" },
                 new Termekek { Id = 14, nev = "Magyar Kártya",  ar = 990,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Magyar_Kartya.png" },
                 new Termekek { Id = 15, nev = "Magyar Népmesék",  ar = 8490,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Magyar_Nepmesek.png" },
                 new Termekek { Id = 16, nev = "Magyarország kvíz",  ar = 2590,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Magyarország kvíz.jpg" },
                 new Termekek { Id = 17, nev = "Maradj Talpon!",  ar = 7690,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Maradj_Talpon.png" },
                 new Termekek { Id = 18, nev = "Monopoly Budapest",  ar = 7790,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Monopoly_Budapest.png" },
                 new Termekek { Id = 19, nev = "Póker Kártya",  ar = 990,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Poker.png" },
                 new Termekek { Id = 20, nev = "Sheriff",  ar = 9990,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/sheriff.png" },
                 new Termekek { Id = 21, nev = "Spongebob Monopoly",  ar = 6690,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Spongebob_Monopoly.png" },
                 new Termekek { Id = 22, nev = "Sponsio	",  ar = 4490,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Sponsio.png" },
                 new Termekek { Id = 23, nev = "Szerencskerék",  ar = 2590,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Szerencsekerek.png" },
                 new Termekek { Id = 24, nev = "Tom & Jerry",  ar = 2290,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Tom_es_Jerry.png" },
                 new Termekek { Id = 25, nev = "Twister",  ar = 3490,   tipus = "Társasjáték", kep = "/Content/Images/tarsas/Twister.png" },
                 new Termekek { Id = 26, nev = "UNO",  ar = 2490,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Uno.png" },
                 new Termekek { Id = 27, nev = "Yu-Gi-Oh",  ar = 4090,   tipus = "Kártyajáték", kep = "/Content/Images/kartyak/Yugioh.png" },
                 new Termekek { Id = 28, nev = "Zsetonok",  ar = 890,   tipus = "Kiegészítő", kep = "/Content/Images/kiegek/zsetonok.png" },
            }.ForEach(u => context.Termekek.Add(u));

            var genres = new List<Genre>
            {
                new Genre { Name = "Nemtom" },
                new Genre { Name = "Másik" },
                new Genre { Name = "éasiohasdhalésid" },
